...
DEBIAN_FRONTEND=noninteractive sudo apt-get install -y mariadb-server-10.3 unixodbc-dev git cmake gcc libssl-dev tar curl libcurl4-openssl-dev libkrb5-dev 
