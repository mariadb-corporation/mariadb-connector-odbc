...
ODBC_TEST(t_bug28255)
{
  ...
  CHECK_STMT_RC(Stmt, SQLSetPos(Stmt, 1, SQL_POSITION, SQL_LOCK_NO_CHANGE));
  EXPECT_STMT(Stmt, SQLSetPos(Stmt, 1, SQL_DELETE, SQL_LOCK_NO_CHANGE), SQL_ERROR);
...
MA_ODBC_TESTS my_tests[]=
{
  ...
  {t_pos_datetime_delete1, "t_pos_datetime_delete1", NORMAL, SkipIfRsStreaming},
  {t_getcursor, "t_getcursor",     NORMAL},
  {t_getcursor1, "t_getcursor1",   NORMAL},
  {t_acc_crash, "t_acc_crash",     NORMAL, SkipIfRsStreaming},
  {tmysql_setpos_del, "tmysql_setpos_del",     NORMAL, SkipIfRsStreaming},
  {tmysql_setpos_del1, "tmysql_setpos_del1",   NORMAL, SkipIfRsStreaming},
  {tmysql_setpos_upd, "tmysql_setpos_upd",     NORMAL, SkipIfRsStreaming},
  {tmysql_setpos_add, "tmysql_setpos_add",     NORMAL, SkipIfRsStreaming},
  {tmysql_pos_delete, "tmysql_pos_delete",     NORMAL, SkipIfRsStreaming},
  ...
  {tmysql_setpos_pkdel,   "tmysql_setpos_pkdel",   NORMAL, SkipIfRsStreaming},
  {t_alias_setpos_pkdel,  "t_alias_setpos_pkdel",  NORMAL, SkipIfRsStreaming},
  {t_alias_setpos_del,    "t_alias_setpos_del",    NORMAL, SkipIfRsStreaming},
  {tmysql_setpos_pkdel2,  "tmysql_setpos_pkdel2",  NORMAL, SkipIfRsStreaming},
  {t_setpos_upd_bug1,     "t_setpos_upd_bug1",     NORMAL, SkipIfRsStreaming},
  {my_setpos_upd_pk_order,"my_setpos_upd_pk_order",NORMAL, SkipIfRsStreaming},
  {my_setpos_upd_pk_order1, "my_setpos_upd_pk_order1", NORMAL, SkipIfRsStreaming},
  ...
  {t_update_offsets, "t_update_offsets", NORMAL, SkipIfRsStreaming},
  {t_bug6157, "t_bug6157",   NORMAL, SkipIfRsStreaming},
  {t_bug32420, "t_bug32420", NORMAL},
  {t_cursor_pos_static, "t_cursor_pos_static",   NORMAL, SkipIfRsStreaming},
  {t_cursor_pos_dynamic, "t_cursor_pos_dynamic", NORMAL, SkipIfRsStreaming},
  {t_bug11846, "t_bug11846",     NORMAL},
  {t_dae_setpos_insert, "t_dae_setpos_insert", NORMAL},
  {t_dae_setpos_update, "t_dae_setpos_update", NORMAL, SkipIfRsStreaming},
  {t_bug39961, "t_bug39961",        NORMAL, SkipIfRsStreaming},
