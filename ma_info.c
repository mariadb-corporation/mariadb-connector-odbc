...
MADB_TypeInfo TypeInfoV3[]=
{
  ...
  {"NUMERIC",SQL_NUMERIC,MADB_DECIMAL_MAX_PRECISION,"","","'precision,scale'",1,0,3,0,0,1,"NUMERIC", -308,308,0,0,10, SQL_NUMERIC}, /* Todo: ?? */
  {"DECIMAL",SQL_DECIMAL,MADB_DECIMAL_MAX_PRECISION,"","","'precision,scale'",1,0,3,0,0,1,"DECIMAL",-308,308,0,0,10, SQL_DECIMAL},
